            ...
            <section>
                <form action="" method="post">
                    <fieldset>
                        ...
                        <select id="Emergency level" name="Emergency_level">
                            <option>All</option>
                            <option>Low</option>
                    ...
                    <tbody>
                        <?php if (!empty($filtered_tickets)) : ?>
                            <?php foreach ($filtered_tickets as $ticket) : ?>
                                ...
                                <td>
                                    <a href="cview.php?id=<?php echo $ticket['id']; ?>">
                                    <a href="cview.php?id=<?php echo urlencode($ticket['id']); ?>" class="hidden-ticket-id"><img id="icon" src="images/view.jpg" alt="View" width="20" height="20"></a>
